...
import static com.jiw.androidpos.sdk.Command.F_CONTROL_DATA_LEN_EXCLUDE_NOT_DATA;
import static com.jiw.androidpos.sdk.Command.F_CONTROL_DAT_BYTE;
import static com.jiw.androidpos.sdk.Command.T_CONTROL_DATA_LEN_EXCLUDE_NOT_DATA;
import static com.jiw.androidpos.sdk.Command.T_CONTROL_DAT_BYTE;
...
//            byte[]  Str2 = cipher.doFinal(dec.decode(str));
    ...
    public static String AesDecrypt(byte[] _str, byte[] _key) {
        ...
        try {
            ...
            byte[] byteT = com.jiw.androidpos.org.apache.commons.net.util.Base64.decodeBase64(encrypted);
