package com.jiw.androidpos.sdk;

import static com.jiw.androidpos.sdk.ble.bleWoosimSdk.MESSAGE_CONNECTED_FAIL;
import static com.jiw.androidpos.sdk.ble.bleWoosimSdk.MESSAGE_CONNECTED_TIMEOUT;
import static com.jiw.androidpos.sdk.ble.bleWoosimSdk.MESSAGE_DEVICE_NAME;
import static com.jiw.androidpos.sdk.ble.bleWoosimSdk.MESSAGE_READ;
import static com.jiw.androidpos.sdk.ble.bleWoosimSdk.MESSAGE_TOAST;
import static com.jiw.androidpos.sdk.ble.bleWoosimSdk.TOAST;
...
import com.jiw.androidpos.AppToAppActivity;
import com.jiw.androidpos.BaseActivity;
import com.jiw.androidpos.Main2Activity;
import com.jiw.androidpos.PopupActivity;
import com.jiw.androidpos.sdk.Devices.AutoDetectDevices;
import com.jiw.androidpos.sdk.Devices.Devices;
import com.jiw.androidpos.sdk.SerialPort.FTDISerial;
import com.jiw.androidpos.sdk.SerialPort.KocesSerial;
import com.jiw.androidpos.sdk.SerialPort.SerialInterface;
import com.jiw.androidpos.sdk.ble.GattAttributes;
import com.jiw.androidpos.sdk.ble.bleSdk;
import com.jiw.androidpos.sdk.ble.bleSdkInterface;
import com.jiw.androidpos.sdk.ble.bleWoosimInterface;
import com.jiw.androidpos.sdk.ble.bleWoosimSdk;
import com.jiw.androidpos.sdk.db.sqliteDbSdk;
import com.jiw.androidpos.sdk.db.sqliteDbSdk.DBTradeResult;
import com.jiw.androidpos.sdk.van.CatNetworkInterface;
import com.jiw.androidpos.sdk.van.Constants;
import com.jiw.androidpos.sdk.van.KocesTcpClient;
import com.jiw.androidpos.sdk.van.NetworkInterface;
import com.jiw.androidpos.sdk.van.TcpInterface;
import com.jiw.androidpos.sdk.van.TmpNetworkInterface;
...
//        CardNumber = CardNumber.replace("*","0");
    ...
    {
        KByteArray _send = new KByteArray();
        _send.Add(_b,_b.length-1);
        if (_sendCheck.value() == _send.value()) {
            return;
        }
        _sendCheck = _send;
...
//                    Toast.makeText(m_Context, "ble 연결이 해제 되었습니다", Toast.LENGTH_SHORT).show();
    ...
    public boolean BleConnect(Context _ctx,String _addr, String _name) {
        ...
        if(_name.contains(Constants.WSP) || _name.contains(Constants.WOOSIM) || _name.contains(Constants.KWANGWOO_KRE)) {
